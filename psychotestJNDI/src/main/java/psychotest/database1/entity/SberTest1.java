package psychotest.database1.entity;
...
public class SberTest1{
    ...
    public SberTest1(Long id, String EXTID_BCKGR, String extid_USER, String TABNUM, String CHANGE_DATE, String EXTID_PROGRAM, String NAME_PROGRAM, String SCALE, String END_DATE_SCORE, String NAME_SCORE, String START_DATE_SCORE, String EXTID_TEST, String NAME_TEST, Double RESULT_SCORE_NUM) {
        this.id = id;
